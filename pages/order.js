      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <h1 className="text-gray-900 text-2xl title-font font-medium mb-4">order id: <span className='text-gray-600 text-xl title-font font-medium '> {router.query.orderId} </span> </h1>
            <p className="leading-relaxed mb-4">Your order had been succsfully placed </p>
            ...
            <div className="flex border-t border-gray-200 py-2">
              ...
              <span className="ml-auto text-gray-900">₹ 458</span>
            </div>
            <div className="flex border-t border-gray-200 py-2">
              <span className="text-gray-500">Tshirt (XL/red)</span>
              <span className="ml-auto text-gray-900">1</span>
              <span className="ml-auto text-gray-900">₹ 458</span>

            </div>
            <div className="flex border-t border-b mb-6 border-gray-200 py-2">
              <span className="text-gray-500">Tshirt (XL/blue)</span>
              <span className="ml-auto text-gray-900">1</span>
              <span className="ml-auto text-gray-900">₹ 458</span>
